(function () {
    ...
    // Creating button elements with styles
    function createButton(id, text, onClick) {
        ...
        // Set initial color for "Analyze Text" button (red)
        if (id === 'analyze-text') {
            button.style.backgroundColor = 'red'; // Set initial color to red
        } else {
            button.style.backgroundColor = '#4CAF50'; // Default green for others
        }
    ...
    function createTimerDisplay() {
        ...
        timerDisplay.style.backgroundColor = '#f4a261'; // Default yellow color
    ...
    function injectButtons() {
        ...
        // New buttons for ChatGPT and Microsoft Copilot
        container.appendChild(createButton('chatgpt-website', 'Go to ChatGPT', goToChatGPT));
        container.appendChild(createButton('copilot-website', 'Go to Microsoft Copilot', goToMicrosoftCopilot));
    ...
    function analyzeText() {
        ...
        // Change the "Analyze Text" button to green when clicked
        document.getElementById('analyze-text').style.backgroundColor = 'green';
    }
    ...
    function startCountdown(seconds) {
        ...
        // Reset timer background to yellow
        ...
        function updateTimer() {
            ...
            if (timeLeft <= 0) {
                ...
                timerDisplay.style.backgroundColor = '#2a9d8f'; // Turns green when time is up

                // Change the color of the new buttons to match the timer
                updateButtonColors('#2a9d8f');
            } else {
                timeLeft--;
            }
        }
    ...
    function analyzeQuestion() {
        ...
        // Reset the color of "Analyze Text" button back to red
        document.getElementById('analyze-text').style.backgroundColor = 'red';
    ...
    // New functions to navigate to ChatGPT and Microsoft Copilot websites
    ...
    // Function to update button colors when the timer finishes
